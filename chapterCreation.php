        ...
        <?php require_once "includes/header.php"; ?>
            <div class="container d-flex justify-content-center" style="margin-top: 100px;">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Write the titleof your chapter and then write the content.</p>
                        <form>
                        <div class="form-group">
                            <label  for="exampleFormControlInput1">Title</label>
                            <input type="text" name="title"class="form-control" id="exampleFormControlInput1" placeholder="MyChapter">
                        </div>
                        <div class="form-group">
